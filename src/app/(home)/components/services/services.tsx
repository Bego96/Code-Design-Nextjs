...
export default function Services() {
  return (
    <div id="services" className='px-8 md:px-16 lg:px-32 mt-20 text-center'>
        <h2 className='text-4xl font-bold text-[#677582] mb-20'>USLUGE</h2>
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8'>
            <div className='group bg-white rounded-xl shadow-md p-6 flex flex-col items-center transform transition hover:scale-105 hover:shadow-xl'>
                    <Image 
