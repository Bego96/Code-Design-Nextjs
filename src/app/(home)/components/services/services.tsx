...
export default function Services() {
  return (
    <div id="services" className='mx-10 xsm:mx-16 sm:mx-20 2xl:mx-32 mt-20 text-center'>
        <h2 className='text-4xl font-bold text-[#677582] mb-20'>USLUGE</h2>
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 p-2 xsm:p-8 gap-10'>
            <div className='flex flex-col items-center drop-shadow-2xl bg-[#FAFAFA] p-4 xsm:p-8 md:p-8'>
                    ...
                    width={500}
                    height={500}
                    className='w-1/3 xsm:w-1/3 xl:w-1/4'
                    />
            ...
            <div className='flex flex-col items-center drop-shadow-2xl bg-[#FAFAFA] p-4 xsm:p-8 md:p-8'>
                    ...
                    width={500}
                    height={500}
                    className='w-1/3 xsm:w-1/3 lg:w-1/4'
                    />
